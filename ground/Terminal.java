...
public abstract class Terminal implements EmergencyState, OccupancyLevel {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Terminal)) {
            ...
            return ((Terminal) obj).getTerminalNumber() == this.getTerminalNumber();
        }
    }
    ...
    @Override
    public int hashCode() {
        return terminalNumber * 5 + this.getClass().getSimpleName().hashCode() * 11;
    }
     ...
     *     encodedGateX is the encoded representation of the Xth gate in this terminal, for X
     *     between 1 and N inclusive, where N is the number of gates, in the same order as returned
     *     by getGates()
     *
     * For example:
    ...
    public String encode() {
        String terminal = String.format("%s:%d:%s:%d\n",
                this.getClass().getSimpleName(),
                this.terminalNumber,
                this.emergency,
                this.gates.size());
