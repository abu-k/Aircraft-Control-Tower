...
public class Gate {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Gate)) {
            ...
            return this.getGateNumber() == ((Gate) obj).getGateNumber();
    ...
    @Override
    public int hashCode() {
        // Since the gate number is unique, it can be used as the hashcode
        return gateNumber * 7;
    }
    ...
    public String encode() {
        return String.format("%d:%s",
                gateNumber,
                getAircraftAtGate() != null ? getAircraftAtGate().getCallsign() : "empty");
    }
}
